...
# auto-trusts the host only on Vercel; off-Vercel behind Cloudflare/Traefik it distrusts the
# forwarded host and every auth call 500s ("problem with the server configuration"). Setting
# AUTH_TRUST_HOST makes it trust the proxy host (@rules/topic-authn-authz.md). Each entry is "KEY=value".
APP_ENV_FIXED=(AUTH_TRUST_HOST=true)
# =======================================================================================
