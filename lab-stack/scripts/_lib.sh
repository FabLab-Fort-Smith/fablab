...
LOCAL_SECRET_KEYS=(AUTH_SECRET JWT_SECRET ENCRYPTION_KEY INTERNAL_API_SECRET SOCKET_API_SECRET MONGO_ROOT_PASSWORD MONGO_APP_PASSWORD MONGO_APP_PASSWORD_PRODUCTION MONGO_APP_PASSWORD_STAGING OBJSTORE_ADMIN_SECRET_KEY OBJSTORE_APP_SECRET_KEY OBJSTORE_BACKUP_SECRET_KEY)
